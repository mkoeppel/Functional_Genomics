...
colnames(MEF2D_peaks) = c("chr","start", "end", "peak_width", "strand", 
                          "peakID", "peak_score", "annotation",
...
p = enrichGO(gene=MEF2D_targets$ENSEMBL,OrgDb="org.Hs.eg.db",
...
heatmap.2(tab,col=cols, margins=c(10,5), scale="row",
          dendrogram="col", Colv=T, Rowv=T, key=TRUE, 
          main="expression of MEF2D target genes",
